...
int main(int argc, char *argv[])
{
    ...
    saida = AbrirArquivoBitSaida(nome_temporario);
    if (saida == NULL)
    {
        fclose(entrada);
    ...
    printf("Compressão de Huffman Adaptativo\n");
    ComprimirArquivoHuffmanAdaptativo(entrada, saida);

    FecharArquivoBitSaida(saida);
    fclose(entrada);
